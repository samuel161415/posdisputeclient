...
const Invalid_modal = ({ isOpen, onClose, data , singleData }) => {
  ...
  return (
    <div className="fixed inset-0  items-center justify-start z-50 bg-black opacity-90 mx-5 my-20 border-2 flex flex-col ">
      <h1 class='text-center text-white w-full pt-7  text-4xl mt-4  '>Invalid</h1>
      <div class='flex  mt-4  w-full'>

      <div class='flex flex-col m-auto p-4 flex-1'>
      ...
      <div class = 'flex-1 p-4'>
        <div class = 'border rounded border-white p-4'>
          <h1 class='text-white text-xl text-center  m-2'> Remark </h1>
          <p class=' text-white'>{singleData.remark}</p>
        </div>
